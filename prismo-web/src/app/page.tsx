  ...
  return (
    <main style={{ padding: 24, maxWidth: 720, margin: "0 auto", fontFamily: "system-ui" }}>
      ...
      <section style={{ marginTop: 48, paddingTop: 24, borderTop: "1px solid #ddd" }}>
        <h2 style={{ marginBottom: 12 }}>Creator Reviews (totally real)</h2>

        <figure style={{ margin: "12px 0" }}>
          <blockquote style={{ margin: 0 }}>
            “i just used ur app to find costco pokemon cards. i'm gonna become a scalper”
          </blockquote>
          <figcaption style={{ color: "#666" }}>— a definitely responsible entrepreneur</figcaption>
        </figure>
        ...
        <figure style={{ margin: "12px 0" }}>
          ...
          <figcaption style={{ color: "#666" }}>— efficiency enjoyer</figcaption>
        </figure>
        ...
        <figure style={{ margin: "12px 0" }}>
          ...
          <figcaption style={{ color: "#666" }}>— inbox minimalist</figcaption>
        </figure>
      </section>
    </main>
  );
